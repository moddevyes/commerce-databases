...
--
-- Table structure for table `orders_order_line_items`
--

DROP TABLE IF EXISTS `orders_order_line_items`;
...
--
-- Dumping data for table `orders_order_line_items`
--

LOCK TABLES `orders_order_line_items` WRITE;
/*!40000 ALTER TABLE `orders_order_line_items` DISABLE KEYS */;
INSERT INTO `orders_order_line_items` VALUES (7,8),(8,8),(9,8),(10,9),(11,9),(12,9);
/*!40000 ALTER TABLE `orders_order_line_items` ENABLE KEYS */;
UNLOCK TABLES;
